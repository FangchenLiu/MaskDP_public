...
ONLINE_TRAIN_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                       ('episode', 'E', 'int'), ('episode_length', 'L', 'int'),
                       ('episode_reward', 'R', 'float'),
                       ('fps', 'FPS', 'float'), ('total_time', 'T', 'time')]

ONLINE_EVAL_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                      ('episode', 'E', 'int'), ('episode_length', 'L', 'int'),
                      ('episode_reward', 'R', 'float'),
                      ('total_time', 'T', 'time')]


OFFLINE_TRAIN_FORMAT = [('step', 'S', 'int'), ('batch_reward', 'BR', 'float'),
                       ('fps', 'FPS', 'float'), ('total_time', 'T', 'time')]

OFFLINE_EVAL_FORMAT = [('step', 'S', 'int'), ('episode_length', 'L', 'int'),
                      ('episode_reward', 'R', 'float'), ('dataset_reward', 'DR', 'float'),
                      ('total_time', 'T', 'time')]
...
class Logger(object):
    def __init__(self, log_dir, use_tb, use_wandb=False, offline=False):
        ...
        self._train_mg = MetersGroup(log_dir / 'train.csv',
                                     formating=OFFLINE_TRAIN_FORMAT if offline else ONLINE_TRAIN_FORMAT,
                                     use_wandb=use_wandb)
        self._eval_mg = MetersGroup(log_dir / 'eval.csv',
                                    formating=OFFLINE_EVAL_FORMAT if offline else ONLINE_EVAL_FORMAT,
                                    use_wandb=use_wandb)
        if use_tb:
